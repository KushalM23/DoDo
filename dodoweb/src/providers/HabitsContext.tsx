        ...
        prev.map(habit =>
          habit.id === habitId
            ? {
                ...
                isPaused: typeof input.isPaused !== 'undefined' ? input.isPaused : habit.isPaused,
                pausedUntil: typeof input.pausedUntil !== 'undefined' ? input.pausedUntil : habit.pausedUntil,
              }
            : habit,
        ),
      );
