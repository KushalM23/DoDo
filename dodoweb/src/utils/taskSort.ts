...
export function sortTasks<T extends Task>(tasks: T[], mode: SortMode = 'smart'): T[] {
    ...
    switch (mode) {
      ...
      default: {
        const scoreA =
          ...
          deadlineWeight(a.deadline) +
          scheduledAtWeight(a.scheduledAt);
        const scoreB =
          priorityWeight(b.priority) +
          deadlineWeight(b.deadline) +
          scheduledAtWeight(b.scheduledAt);
        if (scoreA !== scoreB) {
