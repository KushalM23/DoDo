...
export function ProfileScreen() {
  ...
  useEffect(() => {
    Animated.stagger(120, [
      Animated.spring(heroFade, {
        toValue: 1,
        damping: 18,
        stiffness: 100,
        useNativeDriver: true,
      }),
      Animated.spring(xpFade, {
        toValue: 1,
        damping: 18,
        stiffness: 100,
        useNativeDriver: true,
  ...
  const peakWindow = useMemo(() => {
    const buckets = {Morning: 0, Afternoon: 0, Evening: 0, Night: 0} as Record<
      string,
      number
    >;
    for (const task of completedTasks) {
  ...
  return (
    <SafeAreaView style={mainStyles.container} edges={['top']}>
      <Animated.ScrollView
        ...
        <Animated.View
          style={[
            mainStyles.heroBlock,
            {
              opacity: heroFade,
              transform: [
                {
                  translateY: heroFade.interpolate({
                    inputRange: [0, 1],
                    outputRange: [20, 0],
                  }),
                },
        ...
        <Animated.View
          style={[
            mainStyles.xpSection,
            {
              opacity: xpFade,
              transform: [
                {
                  translateY: xpFade.interpolate({
                    inputRange: [0, 1],
                    outputRange: [20, 0],
                  }),
                },
          ...
          <View style={mainStyles.levelRow}>
            ...
            <View style={mainStyles.streakRow}>
              ...
              <Text style={mainStyles.streakNum}>
        ...
        <Animated.View
          style={[
            mainStyles.statsSection,
            {
              opacity: statsFade,
              transform: [
                {
                  translateY: statsFade.interpolate({
                    inputRange: [0, 1],
                    outputRange: [20, 0],
                  }),
                },
