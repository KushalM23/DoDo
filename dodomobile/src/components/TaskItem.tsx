...
function priorityIcon(
  priority: number,
): 'arrow-up-circle' | 'minus-circle' | 'arrow-down-circle' {
  if (priority === 3) {
...
export function TaskItem({
  ...
  const leadingIconColor = isHabit
    ? colors.habitBadge
    : category?.color ?? colors.mutedText;
  ...
  const priorityIconColor = isHabit
    ? colors.habitBadge
    ...
    <View style={styles.outer}>
      ...
      <Animated.View
        style={[
          ...
          {
            transform: [
              {translateX: selectionMode ? 0 : translateX},
              {scale: pressScale},
            ],
          },
        ]}
        ...
        {selectionMode ? (
          ...
          <Pressable
            style={styles.checkboxWrap}
            onPress={() => onToggleRef.current(taskRef.current)}>
            <View
              style={[
                styles.checkbox,
        ...
        {showLeadingIcon && leadingIcon ? (
          <View
            style={[
              styles.leadingIconPill,
              {backgroundColor: `${leadingIconColor}18`},
            ]}>
        ...
        <Pressable
          ...
          <View style={styles.metaRow}>
            ...
            <Text style={styles.meta}>
              {formatTime(task.scheduledAt, preferences.timeFormat)}
            </Text>
        ...
        {/* Priority badge */}
        <View
          style={[styles.priorityPill, {backgroundColor: priorityPillColor}]}>
          <AppIcon
