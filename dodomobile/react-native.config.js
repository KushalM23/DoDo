...
module.exports = {
  ...
  dependencies: {
    ...
    '@react-native-async-storage/async-storage': rootDependency(
      '@react-native-async-storage/async-storage',
    ),
    'react-native-safe-area-context': rootDependency(
    ...
    '@react-native-vector-icons/lucide': rootDependency(
      '@react-native-vector-icons/lucide',
    ),
    '@react-native-vector-icons/common': rootDependency(
